<?
       ...
       $body = "Forename: $sforename\nSurname: $ssurname\nSex: $ssex\nHouse Number: $shouse\nStreet: $sstreet\nTown: $stown\nCounty: $scounty\nPostcode: $spostcode\nCountry: $scountry\nLocation: $slocation\nDOB: $sdob\nTel: $stelephone\nMobile: $smobile\nEmail: $semail\nRefering Organisation: $srefOrg\nJob_Quals: $sjobquals\nIndustry: $sindustry\nLanguages: $slanguages\nEthnic Origin: $sethnic\nReligion and Beliefs: $sreligion\nOrientation: $sorientation\nDisability: $sdisability\nInterests: $sinterests\n";
       $sFile = "datafile.csv";
	   $ptrFile = @fopen($sFile, "w");
	   $sData = ($ssurname.",".$forename.",".$ssex.",".$shouse.",".$sstreet.",".$stown.",".$scounty.",".$spostcode.",".$scountry.",".$slocation.",".sdob.",".$stelephone.",".$smobile.",".$semail.",".$sjobquals.",".$sindustry.",".$slanguages.",".$srefOrg.",".$sethnic.",".$sreligion.",".$sorientation.",".$sdisability.",".$sinterests."\n");
	   @fwrite($ptrFile, $sData);
	   @fclose($ptrFile);
	      $to="trustees@russam-gms.co.uk";
		  //$to="james@avecsys.com";
	      $subject="Non Execs Website Enquiry from ".$sname;
	      $from = "mailserver@trustees-unlimited.co.uk";
